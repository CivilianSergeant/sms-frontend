	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel-heading">
				<div class="col-md-12">
					<h4 class="widgettitle">Edit Package

					<a href="<?php echo site_url('add-on-package/view/' . $token) ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-search"></i> View</a>
					<a href="<?php echo site_url('add-on-package'); ?>" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-circle-left"></i> Back</a>
					</h4>
				</div>
		...
		<form name="package" id="package" method="POST" ng-submit="savePackage()">
			...
			<div class="col-md-12">
				<div class="col-md-10">
					<div class="form-group">
						<button type="submit" id="buttonsuccess" ng-disabled="package.$invalid" class="btn btn-success">Update</button>
						<a href="<?php echo site_url('add-on-package'); ?>" class="btn btn-default"> Back </a>
					</div>
				</div>
			</div>
			</form>
