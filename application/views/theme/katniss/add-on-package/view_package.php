				...
				<div class="panel-heading">					
					<h4 class="widgettitle">Program Details
						<?php if(in_array($user_info->user_type,array('mso','MSO'))){ ?>
							<a href="<?php echo site_url('add-on-package/edit') . '/' . $package->get_attribute('token') ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-pencil"></i> Edit</a>
						<?php } ?>
