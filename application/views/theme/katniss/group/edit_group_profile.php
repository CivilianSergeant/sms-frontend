...
<div id="container" ng-controller="EditGroupProfile" ng-cloak>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Edit Group <?php echo ($user_info->user_type == 'MSO')? 'Admin' : 'User'; ?>  [ {{profile.group_name}} ]

                        <a href="<?php echo site_url('groups/view/{{profile.token}}' ) ?>" class="btn btn-success btn-sm pull-right" style="margin-left: 10px"><i class="fa fa-search"></i> View</a>
                        <a href="<?php echo site_url('groups'); ?>" id="buttoncancel" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back</a>
                    </h4>
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" class="form-control" ng-model="profile.group_name" placeholder="Full Name" required="required">
                                                </div>
                                            </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label style="margin-left:190px;" for="password"> <input type="checkbox" ng-checked="profile.is_remote_access_enabled=='1'" ng-model="profile.is_remote_access_enabled"  ng-true-value="'1'" ng-false-value="'0'"/> Remote Login Access Disabled</label>
                                            </div>
                        ...
                        <div id="billing_address" class="tab-pane active" ng-show="tabs.billing_address" style="padding-top:10px;">
                            <form class="form-horizontal" name="lco_billing_address" id="lco_billing_address" method="post" ng-submit="saveBillingAddress()" >
                                <div class="col-md-12" style="padding-bottom: 20px; margin-top:20px;">
                                    ...
                                    ( Same as Profile <input type="checkbox" ng-model="copy_profile" ng-change="setBillingAddress()"/>)
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-5 col-md-offset-1">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="contact"> Mobile No </label>                       
                                                <div class="col-sm-8">
