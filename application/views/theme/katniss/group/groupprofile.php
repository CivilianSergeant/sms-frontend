...
?>
<div id="container" ng-controller="CreateGroupProfile" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Add New Group Account [ {{((token!=null)? profile.full_name:'Unsaved Profile')}} ]
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-8 control-label" for="password"><input type="checkbox" ng-model="profile.is_remote_access_enabled" ng-true-value="1" ng-false-value="0"/> Remote Login Access Disabled</label>
                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> <?php echo (strtolower($user_info->user_type) == 'mso')? 'Group' : 'User'; ?> Accounts
                        <a ng-if="permissions.create_permission == '1'" ng-click="showForm()" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Add New Group</a>
                    </h4>
