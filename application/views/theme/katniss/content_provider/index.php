...
<div id="container" ng-controller="CreateContentProvider" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    <h4 class="widgettitle"> New Content provider
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="col-md-3" style="padding-bottom: 20px">
                                    <!--<h4 class="widgettitle">Add New Content Provider</h4>-->
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-4">
                                              <select class="form-control" id="content_aggregator_type" ng-model="formData.content_aggregator_type">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="checkbox">
                                                    <label id="is_active"><input type="checkbox" ng-model="formData.is_active" ng-checked="formData.is_active" ng-true-value="1" ng-false-value="0"/></label>
        ...
        <div class="row">
                ...
                <div class="panel-heading">
                    <div class="col-md-12">
                        <h4 class="widgettitle">
                            ...
                            <a ng-if="permissions.create_permission == '1'" ng-click="showForm()" id="buttoncancel" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Add New Content Provider </a>
                    </div>
                    <span class="clearfix"></span>
                </div>
                <hr/>
            ...
            <div class="panel-body">
                ...
                <!-- <div class="col-md-12 text-center" ng-if="delete_flag">
                    <form>
                        <p><strong>Are you sure to delete this Content Provider</strong></p>
                        <p>
