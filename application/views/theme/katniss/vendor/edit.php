        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    <h4 class="widgettitle"> Edit Vendor
                        <a href="<?php echo site_url('vendor'); ?>" id="buttoncancel" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back </a>
                        <a href="<?php echo site_url('vendor/view'); ?>/{{formData.id}}" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-search"></i>  View </a>
                    </h4>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                            <button type="submit" ng-disabled="!updateVendor.$valid" class="btn btn-success btnNext"> Update Vendor </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
