        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> 
                        ...
                        <a href="<?php echo site_url('foc-subscriber'); ?>" id="buttoncancel" class="btn btn-primary btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back</a>
                    </h4>
            ...
            <div class="panel-body">
                ...
                <div class="row" ng-repeat="ap in assigned_packages" ng-if="!formData.pairing_id">
                        ...
                        <div class="col-md-12">    
                            <div class="col-md-12">
                                <h4 style="border-bottom:1px solid #dedede;">Pairing ID: {{ap.pairing_id}} [ <small>No of days: {{ap.no_of_days}}</small> ]  
