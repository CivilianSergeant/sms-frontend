        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    <h4 class="widgettitle"> Edit Transcoder
                        ...
                        <a href="<?php echo site_url('transcoder/view'); ?>/{{formData.id}}" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-search"></i>  View </a>
                    </h4>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-4 col-md-offset-4">
                                            <button type="submit" ng-disabled="!updateTranscoder.$valid" class="btn btn-success btnNext"> Update Transcoder </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
