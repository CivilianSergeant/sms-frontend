...
<script type="text/javascript">
    ...
    var subscriber_name = "<?php echo $subscriber_name; ?>";
</script>
<div id="container" ng-controller="AddOnPackages" ng-cloak>
                    ...
                    <form class="form-horizontal" >
                        <div id="package_assign" class="form-horizontal" style="padding-top:10px;">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <label class="control-label">Available Add-On Package List</label>
                                        <select id="select-from" class="form-control" ng-model="selected_package" ng-disabled="(packages.length<=0 || (stb_card_id == null))">
                            ...
                            <div class="row" ng-repeat="ap in assigned_package_list" ng-if="!formData.pairing_id">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <h5 style="border-bottom:1px solid #dedede;">Pairing ID: {{ap.pairing_id}}  [ <small>Charge Type: {{((ap.charge_type=='1')?  'By Amount':'By Package')}}</small> ]
