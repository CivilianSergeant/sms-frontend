...
<div id="container" ng-controller="FocPackageReAssign" ng-cloak>
                ...
                <div class="col-md-12">
                    <div class="panel-heading">
                            ...
                            <h4 class="widgettitle"> Package Re-assign <span ng-if="profile.id">[ {{profile.subscriber_name}} ]</span> 
                                ...
                                <a href="<?php echo site_url('foc-subscriber'); ?>" id="buttoncancel" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back</a>
                            </h4>
