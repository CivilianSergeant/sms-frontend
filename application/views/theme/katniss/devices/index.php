		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="panel-heading">
					<h4 class="widgettitle"> New Device
						...
						<div class="panel-body">
							<div class="col-md-12">
								<div class="col-md-3" style="padding-bottom: 20px">
									<h4 class="widgettitle">Add New Device</h4>
								</div>
							</div>
								...
								<div class="col-md-12">
									<div class="col-md-10">
										...
										<div class="col-md-4 col-md-offset-4">									
											<a id="btnNext" ng-click="saveStb()" ng-disabled="!stbAdd.$valid" class="btn btn-success btnNext"> Save Device </a>
										</div>
									</div>
								</div>
							</form> 
				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">
							All Device List
							<a ng-if="permissions.create_permission == '1'" ng-click="showForm()" id="buttoncancel" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Add New Device </a>
						</div>
						<span class="clearfix"></span>
					</div>
					<hr/>			
