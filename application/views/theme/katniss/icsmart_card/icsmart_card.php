			...
			<div id="container" ng-controller="CreateICSmartcard" ng-cloak>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="panel-heading">
								...
								<h4 class="widgettitle"> Add New IC or Smartcard
							...
							<div class="tab-content">
								<div id="home" class="tab-pane fade in active">		
									<div class="panel-body">
										<form action="<?php echo site_url('icsmart-card/create'); ?>" method="POST" name="icAdd" class="form-horizontal">
											<div class="col-md-12" style="margin-top:20px;">
												<div class="col-md-12">
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="internal_card_number" ng-model="ic_smartcard.internal_card_number" placeholder="Enter IC Internal Number" required="required" readonly="readonly">
														</div>
													</div>			
													<div class="form-group">
														<label class="col-sm-4 control-label" for="external_card_number">External Card Number <span style="color:red">*</span></label>						
														<div class="col-sm-4">
															<input type="text" maxlength="16" ng-keydown="onKeydown()" class="form-control" id="external_card_number" ng-model="ic_smartcard.external_card_number" placeholder="Enter External Number" required="required">
														</div>
													</div>							
													<div class="form-group">
														<label class="col-sm-4 control-label" for="smart_card_provider">Smart Card Provider <span style="color:red">*</span></label>						
														<div class="col-sm-4">
															<select class="form-control" id="smart_card_provider" ng-model="ic_smartcard.smart_card_provider" required="required">
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="number" class="form-control" id="price" ng-model="ic_smartcard.price" placeholder="Enter Price" required="required">
														</div>
													</div>
													<div class="col-md-4 col-md-offset-4">									
														<a id="btnNext" ng-click="saveICSmartcard()" ng-disabled="!icAdd.$valid" class="btn btn-success btnNext" > Save IC or Smartcard</a>
													</div>
												</div>
											</div>
										</form> 
								...
								<div id="menu1" class="tab-pane fade">
									<div class="panel-body">
										...
										<form action="<?php echo site_url('icsmart-card/export'); ?>" method="post" class="form-horizontal">
											<div class="col-md-12">
												<div class="col-md-10">			
													<!-- <div class="form-group">
														<label class="col-sm-4 control-label" for="external_card_number">External Card Number <span style="color:red">*</span></label>						
							...
							<div class="panel-heading">
								<div class="col-md-12">
									<h4 class="widgettitle">
										All IC or Smart Card List
										<a ng-if="permissions.create_permission == '1'" ng-click="showForm(); removeAlert()" id="buttoncancel" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Add New IC or Smartcard </a>
									</div>
									<span class="clearfix"></span>
								</div>
								<hr/>			
