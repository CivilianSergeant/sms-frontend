...
?>
<div id="container" ng-controller="CreateLCOProfile" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Add New LCO <?php echo ($user_info->user_type == 'MSO')? 'Admin' : 'User'; ?> [ {{((token!=null)? profile.full_name:'Unsaved Profile')}} ] 
...
<!--                                <li ng-class="{active:tabs.business_region}" ng-if="billing_address_id != null"><a class="tab_top" ng-click="setTab('business_region')">Business Region</a></li>-->
                    ...
                    <div class="tab-content">
                        <div id="profile" class="tab-pane active" ng-show="tabs.profile">
                            <form class="form-horizontal" name="lco_profile" id="lco_profile" ng-submit="saveProfile()" method="post" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label" for="created_by">Full Name <span class="text-danger">*</span></label>                       
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label" for="email">Email <span class="text-danger">*</span></label>                       
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label" for="contact"> Mobile Number <span class="text-danger">*</span></label>                       
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" maxlength="11" ng-model="profile.contact"  required="required"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label" for="address2"> 2<sup>nd</sup> Mobile Number (Same as Above <input type="checkbox" ng-model="billing_contact_auto" ng-change="changeBillingContact()"/>)</label>                       
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-md-5">                          
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">        
                                                    <select class="form-control" id="division_id" ng-model="profile.division_id" ng-disabled="!profile.country_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">  
                                                    <select class="form-control" id="district_id" ng-model="profile.district_id" ng-disabled="!profile.division_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">  
                                                    <select class="form-control" id="area_id" ng-model="profile.area_id" ng-disabled="!profile.district_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">  
                                                    <select class="form-control" id="sub_area_id" ng-model="profile.sub_area_id" ng-disabled="!profile.area_id">
                                        ...
                                        <div class="col-md-10 text-right">
                                            <input type="submit" id="buttonsuccess" ng-disabled="lco_profile.$invalid" class="btn btn-success" value="Save Profile"/>
                        ...
                        <div id="login" class="tab-pane active" ng-show="tabs.login" style="padding-top:10px;">
                            <form class="form-horizontal" name="lco_login" id="lco_login" method="post">
                                <div class="row">
                                    <hr/>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="re_password">Retype Password <span style="color:red">*</span></label>                      
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label" for="password" style="margin-left:147px;"><input type="checkbox"  ng-model="profile.is_remote_access_enabled" ng-true-value="'1'" ng-false-value="'0'"/> Remote Login Access Disabled</label>
                                            </div>
                                            <div class=" form-group">
                        ...
                        <div id="billing_address" class="tab-pane active" ng-show="tabs.billing_address" style="padding-top:10px;">
                            <form class="form-horizontal" name="lco_billing_address" id="lco_billing_address" method="post" ng-submit="saveBillingAddress()">
                                <div class="col-md-12" style="padding-bottom: 20px; margin-top:20px;">
                                    ...
                                    ( Same as Profile <input type="checkbox" ng-model="copy_profile" ng-change="setBillingAddress()" ng-true-value="1" ng-false-value="0"/>)
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="full_name">Full Name <span style="color:red">*</span></label>                       
                                                <div class="col-sm-8">
                                                    <input type="hidden" name="created_by" value="<?php echo $user_info->id; ?>">
                                                    <input type="text" class="form-control" ng-model="billing_address.full_name" placeholder="Full Name" required="required">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="contact"> Mobile No <span class="text-danger">*</span></label>                       
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" maxlength="11" ng-model="billing_address.contact" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="billing_contact"> Billing Mobile No  Same as Mobile No <input type="checkbox" ng-model="billing_contact_auto" ng-change="changeBillingContact()"/></label>                       
                                                <div class="col-sm-8">
                                        ...
                                        <div class="col-md-6">                          
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="country_id">Country</label>                      
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="country_id" ng-model="billing_address.country_id" ng-change="changeCountry()">
                                                        <option value="">---Select Country---</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="division_id">Divisions</label>                        
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="division_id" ng-model="billing_address.division_id" ng-change="changeDivision()" ng-disabled="!billing_address.country_id">
                                                        <option value="">--Select Division--</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="district_id">District</label>                     
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="district_id" ng-model="billing_address.district_id" ng-change="changeDistrict()" ng-disabled="!billing_address.division_id">
                                                        <option value="">--Select District--</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="area_id">Area</label>                     
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="area_id" ng-model="billing_address.area_id" ng-change="changeArea()" ng-disabled="!billing_address.district_id">
                                                        <option value="">--Select Area--</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="sub_area_id">Sub Area</label>                     
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="sub_area_id" ng-model="billing_address.sub_area_id" ng-change="changeSubArea()" ng-disabled="!billing_address.area_id">
                                                        <option value="">--Select Sub Area--</option>
                                        ...
                                        <div class="col-md-12  text-right">
                                            <input type="submit" id="buttonsuccess" ng-disabled="lco_billing_address.$invalid" class="btn btn-success btnNext" value="Save Profile"/>
                                            <a id="buttoncancel" id="btnNext" ng-click="hideForm()" class="btn btn-warning btnNext" >Cancel</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="photo" class="tab-pane active" ng-show="tabs.photo"  style="padding-top: 10px">
                            <form class="form-horizontal" name="lco_photo" id="lco_photo" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <style type="text/css">
                    ...
                    <div id="identity_verify" class="tab-pane active" ng-show="tabs.identity_verify"  style="padding-top: 10px">
                        <form class="form-horizontal" name="lco_photo" id="lco_photo" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel-heading">
            ...
            <div id="business_modality" class="tab-pane active" ng-show="tabs.business_modality"  style="padding-top: 10px">
                <form name="lco_photo" id="lco_photo" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel-heading">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="10" id="business_modality" ng-model="modality.business_modality" class="form-control" style="height: 150px ! important;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <a id="buttonsuccess" id="btnNext" class="btn btn-success btnNext" ng-click="saveModality()"> Save Business Modality </a>
                                </div>
                            </div>                          
                        </div> 
                    </div>                      
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel-heading">
                ...
                <h4 class="widgettitle"> LSP <?php echo ($user_info->user_type == 'MSO')? 'Admins' : 'Users'; ?>
                    <?php if($user_info->user_type != "Group"){ ?>
                        <?php if($user_info->user_type != "LCO"){ ?>
                    <a ng-if="permissions.create_permission == '1'" href="<?php echo site_url('lco/import'); ?>" class="btn btn-primary btn-sm pull-right" style="margin-left:10px;"><i class="fa fa-plus-circle"></i> Import LCO</a>
                        <?php } ?>
                        <a ng-if="permissions.create_permission == '1'" ng-click="showForm()" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Add New LCO</a>
                    <?php } ?>
                </h4>
