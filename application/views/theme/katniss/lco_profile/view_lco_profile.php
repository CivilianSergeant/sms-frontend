        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                    <h4 class="widgettitle"> View LSP <?php echo ($user_info->user_type == 'MSO')? 'Admin' : 'User'; ?> [ {{profile.lco_name}} ]
                        <?php if(($lco_role_type == "admin" && $user_info->user_type=='MSO') || ($lco_role_type == "staff" && $user_info->user_type=='LCO')){ ?>
                            <a href="<?php echo site_url('lco/edit/{{profile.token}}' ) ?>" class="btn btn-success btn-sm pull-right" style="margin-left: 10px"><i class="fa fa-pencil"></i> Edit</a>
                        <?php } ?>
                    ...
                    <div class="tab-content" ng-if="!loader">
                        ...
                        <div class="profile panel-body tab-pane active" id="login">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label id="view" class="col-md-6 control-label" for="username">Is Active:</label>                      
                        ...
                        <?php if(0){ //in_array($user_info->user_type,array("MSO","Group")) ?>
