...
?>
<div id="container" ng-controller="LcoImport" ng-cloak>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                    <div class="col-md-12">
                        <h4 class="widgettitle pull-left">Import LCO</h4>
                        <a href="<?php echo base_url('public/downloads/lco-template.xlsx'); ?>" class="btn btn-info btn-sm pull-right" style="margin-left:10px;"><i class="fa fa-plus-circle"></i> Download Template</a>
                    ...
                    <div style="margin-bottom: 40px">
                        <div ng-hide="messageState">
                            ...
                            <!--<div class="form-group">
                                <select class="form-control" ng-model="business_region_l1" ng-change="setRegionLevel2()">
                                    <option value="">--SELECT-REGION-Level1--</option>
                                    <option ng-repeat="r1 in regions" value="{{r1.id}}">{{r1.name}}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control" ng-model="business_region_l2" ng-change="setRegionLevel3()">
                                    <option value="">--SELECT-REGION-Level2--</option>
                                    <option ng-repeat="r2 in regions_level_2" value="{{r2.id}}">{{r2.name}}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control" ng-model="business_region_l3" ng-change="setRegionLevel4()">
                                    <option value="">--SELECT-REGION-Level3--</option>
                                    <option ng-repeat="r3 in regions_level_3" value="{{r3.id}}">{{r3.name}}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control" ng-model="business_region_l4">
                            ...
                            <button ng-disabled="loader" ng-click="uploadFile()" class="btn btn-success btn-s" type="button" disabled="disabled">
