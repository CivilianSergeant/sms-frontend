					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="panel-heading">
								...
								<h4 class="widgettitle"> Update Set-Top Box

									<a href="<?php echo site_url('set-top-box/view/' . $stbs->stb_id) ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-search"></i> View</a>
									<a href="<?php echo site_url('set-top-box'); ?>" id="buttoncancel" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back </a>
								</h4>
								...
								<div class="col-md-12">
									<div class="col-md-10">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" id="external_card_number" name="external_card_number" value="<?php echo $stbs->external_card_number; ?>" required="required" readonly="readonly">
											</div>
										</div>							
										<div class="form-group">
