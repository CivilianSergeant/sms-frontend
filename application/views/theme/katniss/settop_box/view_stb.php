					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="panel-heading">
								...
								<h4 class="widgettitle"> STB Detail

									<a href="<?php echo site_url('set-top-box/edit/' . $stbs->stb_id) ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-pencil"></i> Edit</a>
								...
								<table class="table">
									<tbody>
										<tr>
											...
											<td>: <?php echo $stbs->internal_card_number; ?></td>
										</tr>
										<tr>
											<th>External Card Number</th>
											<td>: <?php echo $stbs->external_card_number; ?></td>
										</tr>
										<tr>
											<th>Provider</th>
											<td>: <?php echo $stbs->stb_provider; ?></td>
										</tr>
										<tr>
											<th>Price</th>
