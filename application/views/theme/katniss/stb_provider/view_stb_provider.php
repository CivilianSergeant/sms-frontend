			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="panel-heading">
						...
						<h4 class="widgettitle"> STB Provider Detail

							<a href="<?php echo site_url('stb-provider/edit/' . $provider->get_attribute('id') ) ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-pencil"></i> Edit</a>
