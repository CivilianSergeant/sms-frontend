        ...
        <div class="row" >
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    <div class="col-md-12">
                        <h4 class="widgettitle">Add New Channel
                ...
                <div class="col-md-12">
                    <form class="form-horizontal" name="saveIptvProgram" ng-submit="saveIpTvProgram()" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="control-label col-md-3">Channel Name <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" ng-model="formData.program_name" maxlength="20" requried="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <span><small><em>(Max filesize 1M and supported formats png, minimum size [<?php echo $image_sizes['minimum']['width'] . 'x' . $image_sizes['minimum']['height']; ?>] pixel )</em></small></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                <input type="checkbox" ng-model="formData.mobile_thumb" ng-checked="formData.mobile_thumb == 1" ng-true-value="1" ng-false-value="0" id="mobile_thumb"/> <label for="mobile_thumb">Mobile Thumbnail ( <?php echo $image_sizes['advance']['MOBILE_THUMB']['width'] . 'x' . $image_sizes['advance']['MOBILE_THUMB']['height']; ?> pixel)</label>
                            </div>
                        </div>
                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                <input type="checkbox" ng-model="formData.mobile_logo" ng-checked="formData.mobile_logo == 1" ng-true-value="1" ng-false-value="0" id="mobile_logo"/> <label for="mobile_logo">Mobile Channel Logo ( <?php echo $image_sizes['advance']['MOBILE_LOGO']['width'] . 'x' . $image_sizes['advance']['MOBILE_LOGO']['height']; ?> pixel)</label>
                            </div>
                        </div>

                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                <input type="checkbox" ng-model="formData.mobile_poster" ng-checked="formData.mobile_poster == 1" ng-true-value="1" ng-false-value="0" id="mobile_poster"/> <label for="mobile_poster">Mobile Poster ( size [ <?php echo $image_sizes['advance']['MOBILE_POSTER']['width'] . 'x' . $image_sizes['advance']['MOBILE_POSTER']['height']; ?> ] pixel)</label>
                            </div>
                        </div>
                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                <input type="checkbox" ng-model="formData.web_poster" ng-checked="formData.web_poster == 1" ng-true-value="1" ng-false-value="0" id="web_poster"/> <label for="web_poster">Web Poster ( size [ <?php echo $image_sizes['advance']['WEB_POSTER']['width'] . 'x' . $image_sizes['advance']['WEB_POSTER']['height']; ?> ] pixel)</label>
                            </div>
                        </div>
                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                <input type="checkbox" ng-model="formData.stb_poster" ng-checked="formData.stb_poster == 1" ng-true-value="1" ng-false-value="0" id="stb_poster"/> <label for="stb_poster">STB Poster ( size [ <?php echo $image_sizes['advance']['STB_POSTER']['width'] . 'x' . $image_sizes['advance']['STB_POSTER']['height']; ?> ] pixel )</label>
                            </div>
                        </div>
                        <div class="form-group" ng-if="showAdv == 1">
                            <div class="col-md-6 col-md-offset-3">
                                                                                        ...
                                                                                        <div ng-hide="messageState">
                                                                                                <div class="input-file">
                                                                                                                ...
                                                                                                                <span class="input-group-addon">
                                                                                                                        <a href="javascript:;" class="btn btn-primary">
                                                                                                                                Browse
                                                                                                                                <input type="file" style="height:34px;" onchange="$(this).parent().parent().parent().find('.form-control').html($(this).val());" accept="application/json" uploader="UploaderChannelLogo" nv-file-select="">
                                                                                                                        </a>
                                                                                                                  </span>
                                                                                                </div>
                        
                                                                                        </div>
                                                                                        <span><small><em>(Max filesize 1M and supported formats png, size [ <?php //echo $image_sizes['channel_logo']['width'].'x'.$image_sizes['channel_logo']['height'];    ?> ] pixel )</em></small></span>
                                                                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <span><small><em>(Max filesize 1M and supported formats png, size [ <?php echo $image_sizes['watermark']['width'] . 'x' . $image_sizes['watermark']['height']; ?> ] pixel)</em></small></span>
                            </div>
                        ...
                        <!--<div class="form-group">
                                ...
                                <div class="col-md-6">
                                        <input type="text" class="form-control" ng-model="formData.video_trailer_url" required="required"/>
                                </div>
                        </div>-->
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <spant class="input-group-addon" ng-init="shared_url = '<?php echo $settings->default_share_url; ?>live/'">{{shared_url}}</spant>
                                    <input type="text" class="form-control" ng-model="formData.video_share_url" required="required"/>
                                </div>
                            </div>
                        </div>
                        <?php if (!empty($lsps)) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="number" class="form-control" ng-change="showDuration()" ng-model="formData.individual_price" required="required"/>
                            </div>
                        </div>
                        <div class="form-group" ng-if="showDurationFlag">
                        ...
                        <!--<div class="form-group">
                                ...
                                <div class="col-md-2">
                                        <input type="text" class="form-control" ng-model="formData.video_tags" required="required"/>
                                </div>
                        </div>-->
                        ...
                        <!--<div class="form-group">
                                ...
                                <div class="col-md-2">
                                        <input type="text" class="form-control" kendo-datepicker  k-format="'yyyy-MM-dd'" ng-model="formData.recording_date" required="required"/>
                                </div>
                        </div>-->
                        <div class="form-group">
                                    ...
                                    foreach ($service_operators as $key => $value) {
                                        ...
                                        <li>
                                            <label class="checkbox-inline">
                                                <input class="service-opeartor" ng-model="formData.service_operator_id[<?php echo $key; ?>]" ng-checked="isChecked(<?php echo $value->id; ?>)"  ng-true-value="<?php echo $value->id; ?>" ng-false-value="0" type="checkbox"><?php echo $value->telco_name; ?>
                                            </label>
                                        </li>
                                    <?php } ?>
                                </ul>
    ...
    <div class="panel panel-default" ng-if="!addFormFlag">
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                    <div class="col-md-12">
                        <h4 class="widgettitle">All Channel
                            <?php if ($user_info->lsp_type_id != 2) { ?>
                                <a ng-click="showForm()" id="buttoncancel" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add Channel </a>
                            <?php } ?>
                        </h4>
                    </div>
                    <span class="clearfix"></span>
