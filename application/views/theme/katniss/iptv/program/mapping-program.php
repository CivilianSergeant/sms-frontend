				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Mapping Channel [<?php echo $program['program_name']; ?>]
							...
							<a href="<?php echo site_url('channels/edit/'.$program['id']); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-pencil"></i> Edit </a>
						</h4>
					</div>
