		...
		<div class="row" >
			...
			<div class="col-md-12">
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Edit Channel [{{formData.program_name}}]
							...
							<a href="<?php echo site_url('channels/view/'.$programId); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-search"></i> View </a>
						</h4>
					</div>
			...
			<div class="panel-body">
				...
				<div class="col-md-12" >
					<form class="form-horizontal" name="updateIptvProgram" ng-submit="updateIpTvProgram()" novalidate>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								<span><small><em>(Max filesize 2M and formats png, minimum <?php echo $image_sizes['minimum']['width'].'x'.$image_sizes['minimum']['height']; ?> pixel)</em></small></span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<?php if(!empty($program['logo_web_url']) && file_exists($program['logo_web_url'])){ ?>
								<div class="col-md-3">
									<img id="webLogo" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.logo_web_url}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
						...
						<div class="form-group" ng-if="showAdv==1">
							...
							<?php if(!empty($program['logo_stb_url']) && file_exists($program['logo_stb_url'])){ ?>
								<div class="col-md-3">
									<img id="stbLogo" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.logo_stb_url}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
							...
							<?php } ?>
                                                ...
                                                <div class="form-group" ng-if="showAdv==1">
							<div class="col-md-3 col-md-offset-3">
                                                            <input type="checkbox" ng-model="formData.mobile_thumb" ng-checked="formData.mobile_thumb==1" ng-true-value="1" ng-false-value="0" id="mobile_thumb"/> <label for="mobile_thumb"><span style="font-size:12px;">Mobile Thumbnail</span> ( <?php echo $image_sizes['advance']['MOBILE_THUMB']['width'].'x'.$image_sizes['advance']['MOBILE_THUMB']['height']; ?> pixel )</label>
							</div>
							<?php if(!empty($program['logo_mobile_url']) && file_exists($program['logo_mobile_url'])){ ?>
								<div class="col-md-3">
                                                                    <img id="mobileThumb" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.logo_mobile_url}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
						...
						<div class="form-group" ng-if="showAdv==1">
							<div class="col-md-3 col-md-offset-3">
                                                            <input type="checkbox" ng-model="formData.mobile_logo" ng-checked="formData.mobile_logo==1" ng-true-value="1" ng-false-value="0" id="mobile_logo"/> <label for="mobile_logo"><span style="font-size:12px;">Mobile Channel Logo</span> ( <?php echo $image_sizes['advance']['MOBILE_LOGO']['width'].'x'.$image_sizes['advance']['MOBILE_LOGO']['height']; ?> pixel )</label>
							</div>
							<?php if(!empty($program['channel_logo']) && file_exists($program['channel_logo'])){ ?>
								<div class="col-md-3">
                                                                    <img id="mobileLogo" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.channel_logo}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
                                                                    <img id="mobileLogo" class="blank-img" ng-src="<?php echo base_url(); ?>public/theme/katniss/img/no-image-found.png"/>
						...
						<div class="form-group" ng-if="showAdv==1">
							...
							<?php if(!empty($program['poster_url_mobile']) && file_exists($program['poster_url_mobile'])){ ?>
								<div class="col-md-3">
									<img id="mobilePoster" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.poster_url_mobile}}"/>
						...
						<div class="form-group" ng-if="showAdv==1">
							...
							<?php if(!empty($program['poster_url_web']) && file_exists($program['poster_url_web'])){ ?>
								<div class="col-md-3">
									<img id="webPoster" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.poster_url_web}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
						...
						<div class="form-group" ng-if="showAdv==1">
							...
							<?php if(!empty($program['poster_url_stb']) && file_exists($program['poster_url_stb'])){ ?>
								<div class="col-md-3">
									<img id="stbPoster" class="thumnail-img" ng-src="<?php echo base_url(); ?>{{formData.poster_url_stb}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
...
<!--						<div class="form-group">
							...
							<div class="col-md-3">
								...
								<span><small><em>(Max filesize 2M and formats png, <?php //echo $image_sizes['channel_logo']['width'].'x'.$image_sizes['channel_logo']['height']; ?> pixel)</em></small></span>
							</div>
							<?php //if(!empty($program['channel_logo']) && file_exists($program['channel_logo'])){ ?>
								<div class="col-md-2">
									<img id="waterMark" style="width:100px; height:57px; margin:0px 70px;" ng-src="<?php //echo base_url(); ?>{{formData.channel_logo}}"/>
								</div>
							<?php //}else{?>
								<div class="col-md-3">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								...
								<span><small><em>(Max filesize 2M and formats png,  <?php echo $image_sizes['watermark']['width'].'x'.$image_sizes['watermark']['height']; ?> pixel)</em></small></span>
							</div>
							...
							<?php }else{?>
								<div class="col-md-3">
									<img id="waterMark" style="width:100px;margin:0px 70px;" ng-src="<?php echo base_url(); ?>public/theme/katniss/img/no-image-found.png"/>
								</div>
							<?php } ?>
						</div>
						<!--<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<input type="number" class="form-control" string-to-number ng-change="showDuration()" ng-model="formData.individual_price" required="required"/>
							</div>
						</div>
						<div class="form-group" ng-show="showDurationFlag">
