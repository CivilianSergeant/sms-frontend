        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <ul class="tab_nav nav nav-tabs">
                    ...
                    <li ng-class="{active:tabs.stb_card}" ng-if="billing_address_id != null && (profile.region_l4_code != 0)"><a class="tab_top" ng-click="setTab('stb_card')">STB & Card</a></li>
                    ...
                    <form name="stb-card" id="stb-card" method="post" ng-submit="addStbCard()" class="form-horizontal">
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="padding-top:20px;">
                                <label class="control-label col-md-2">Set-Top Box ID </label>
                                <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="select-to" ng-model="included_item" ng-disabled="!unassigned_stb_cards.length" style="min-width:245px;min-height:100px;" ng-model="selected_package" multiple="multiple" >
