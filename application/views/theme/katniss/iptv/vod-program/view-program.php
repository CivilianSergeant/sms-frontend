				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">View Content [{{formData.program_name}}]
							...
							<a href="<?php echo site_url('vod-programs/edit/'.$programId); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-pencil"></i> Edit </a>
						</h4>
					</div>
					...
					<form class="form-horizontal" ng-submit="updateIpTvProgram()">
						...
						<div class="form-group">
							...
							<?php if(!empty($program['water_mark_url']) && file_exists($program['water_mark_url'])){ ?>
								<div class="col-md-3">
									<img style="width:100px;margin:0px 70px;" ng-src="<?php echo base_url(); ?>{{formData.water_mark_url}}"/>
								</div>
							<?php }else{ ?>
								<p class="text-center">No Watermark Uploaded</p>
							<?php } ?>
						</div>
						<hr>
						<!--<div class="form-group">
