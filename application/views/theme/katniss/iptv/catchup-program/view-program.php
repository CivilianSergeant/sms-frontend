				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">View Content [{{formData.program_name}}]
							...
							<a href="<?php echo site_url('catchup-programs/edit/'.$programId); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-pencil"></i> Edit </a>
						</h4>
					</div>
