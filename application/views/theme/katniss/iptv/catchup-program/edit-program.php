				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Edit Content [{{formData.program_name}}]
							<a href="<?php echo site_url('catchup-programs'); ?>" id="buttoncancel" class="btn btn-danger btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back </a>
							<a href="<?php echo site_url('catchup-programs/view/'.$programId); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-search"></i> View </a>
						</h4>
					</div>
