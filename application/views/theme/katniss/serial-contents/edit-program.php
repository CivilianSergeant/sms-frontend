				...
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Edit Content [{{formData.program_name}}]
							...
							<a href="<?php echo site_url('serial-contents/view/'.$programId); ?>" id="buttoncancel" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="fa fa-search"></i> View </a>
						</h4>
					</div>
...
<!--						<div class="form-group">
						...
						<div class="form-group">
							...
							<?php if(!empty($program['water_mark_url']) && file_exists($program['water_mark_url'])){ ?>
								<div class="col-md-3">
									<img id="waterMark" style="width:100px;height:70px;margin:0px 70px;" ng-src="<?php echo base_url(); ?>{{formData.water_mark_url}}"/>
								</div>
							<?php }else{?>
								<div class="col-md-3">
