		...
		<div class="row" >
			...
			<div class="col-md-12">
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Add New Serial Content
					...
					<form class="form-horizontal" name="saveIptvProgram" ng-submit="saveIpTvProgram()" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								<span><small><em>(Max filesize 1M and formats png, <?php echo $image_sizes['watermark']['width'].'x'.$image_sizes['watermark']['height']; ?> pixel)</em></small></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="input-group">
									<spant class="input-group-addon" ng-init="shared_url='<?php echo $settings->default_share_url; ?>catchup/'">{{shared_url}}</spant>
						...
						<div class="form-group">
							...
							<div class="col-md-2" style="position: relative;">
								<input type="text" class="form-control" id="videoTags" ng-model="formData.video_tags" ng-disabled="toggleTags==false" ng-if="toggleTags==true" />
								<select class="form-control" ng-model="formData.video_tags" ng-if="toggleTags==false" ng-disabled="toggleTags==true" >
									<?php if(!empty($video_tags)){ ?>
										<?php foreach($video_tags as $video_tag){ ?>
											<option value="<?php echo $video_tag->video_tags; ?>"><?php echo $video_tag->video_tags; ?></option>
										<?php } ?>
									<?php } ?>
								</select>
								<a ng-click="setToggleTags()" style="position: absolute;right:-15px;top:4px;" class="btn btn-info btn-xs">
									<i ng-if="toggleTags==false" class="fa fa-pencil"></i>
									<i ng-if="toggleTags==true"  class="fa fa-list"></i>
								</a>
							</div>
						</div>
	...
	<div class="panel panel-default" ng-if="!addFormFlag">
		<div class="row">
			<div class="col-md-12">
				<div class="panel-heading">
					<div class="col-md-12">
						<h4 class="widgettitle">Serial Contents
