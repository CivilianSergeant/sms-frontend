...
<div id="container" ng-controller="EditSubscriberProfile" ng-cloak>
    ...
    <div class="alert alert-success" ng-show="success_messages.length>0" ng-repeat="sm in success_messages" ng-model="sm">
        <button class="close" ng-click="closeAlertItem($index)">×</button>
        {{sm}}
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Edit Subscriber <span ng-if="profile.id">[ {{profile.subscriber_name}} ]</span> 
...
<!--                        <a href="<?php echo site_url('subscriber/charge/'.$token.'/all'); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-money"></i> Charge</a>
                        ...
                        <a href="<?php echo site_url('subscriber/view/{{profile.token}}'); ?>" class="btn btn-success btn-sm pull-right" style="margin-right: 10px"><i class="fa fa-search"></i> View</a>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <ul class="tab_nav nav nav-tabs">
                    ...
                    <li ng-class="{active:tabs.stb_card}" ng-if="billing_address_id != null"><a class="tab_top" ng-click="setTab('stb_card')">Device</a></li>-->
                    <li ng-class="{active:tabs.package_assign}"><a class="tab_top" ng-click="setTab('package_assign')">Package Assign</a></li>
                    ...
                    <div id="profile" class="tab-pane active" ng-show="tabs.profile">
                        ...
                        <div class="row" ng-if="!loader">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="margin-bottom-sm">
                                            ...
                                            <input type="text" class="form-control" id="email" ng-model="profile.email" placeholder="Enter Your Email" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="margin-bottom-sm">
                                            <input type="text" class="form-control" maxlength="15" ng-model="profile.contact"  required="required"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="margin-bottom-sm">
                                            <select class="form-control" id="road_id" ng-model="profile.road_id" disabled>
                                                ...
                                                <option ng-repeat="road in roads" ng-selected="road.id==profile.road_id" value="{{road.id}}">{{road.road_name}}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" ng-model="profile.identity_type">
                                            ...
                                            <option ng-repeat="type in identity_verify_types" ng-selected="type==profile.identity_type" value="{{type}}">{{type}}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <a id="update" id="btnNext" ng-disabled="subscriber_profile.$invalid" ng-click="updateProfile()" class="btn btn-success btnNext" >Update Profile</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="margin-bottom-sm">
                                        <input type="password" class="form-control" id="re_password" ng-model="profile.re_password" ng-change="checkRePassword()" value="" placeholder="Enter Your Password" required="required">
                                        <div ng-if="checkRePasswordFlag" style="color: red">{{re_pass_message}}</div>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label> <input type="checkbox" ng-model="profile.status" ng-checked="profile.user_status=='1'"  ng-true-value="'1'" ng-false-value="'0'"/> Is Active</label>
                                </div>

                                <div class="form-group">
                                    <label> <input type="checkbox" ng-model="profile.is_remote_access_enabled" ng-checked="profile.is_remote_access_enabled=='1'"  ng-true-value="'1'" ng-false-value="'0'"/> Remote Login Access Disabled</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <form name="subscriber_billing_address" id="subscriber_billing_address" method="post" ng-submit="saveBillingAddress()">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <input type="submit"  ng-disabled="subscriber_billing_address.$invalid" class="btn btn-success" value="Save Billing Address"/>
                ...
                <div id="documents" class="tab-pane active" ng-show="tabs.documents"  style="padding-top: 10px">
                    <form name="subscriber_photo" id="subscriber_photo" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="col-md-12">
                                    <button id="upload-photo" ng-disabled="!uploader.getNotUploadedItems().length" ng-click="uploader.uploadAll()" class="btn btn-success btn-s" type="button" disabled="disabled">
                    ...
                    <form name="subscriber_identity" id="subscriber_identity" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <button  ng-disabled="!identityUploader.getNotUploadedItems().length" ng-click="identityUploader.uploadAll()" class="btn btn-success btn-s" type="button" disabled="disabled">
                                        <span class="glyphicon glyphicon-upload"></span> Upload
                                    </button>
                                </div>
                            </div>
                    ...
                    <form name="subscription" id="subscription" method="post" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <button id="upload" ng-disabled="!subuscriptionUploader.getNotUploadedItems().length" ng-click="subuscriptionUploader.uploadAll()" class="btn btn-success btn-s" type="button" disabled="disabled">
                                        <span class="glyphicon glyphicon-upload"></span> Upload
                                    </button>
                                </div>
                            </div>
                ...
                <div id="stb_card" class="tab-pane active" ng-show="tabs.stb_card"  style="padding-top: 10px">
                    <form name="stb-card" id="stb-card" method="post" ng-submit="addStbCard()" class="form-horizontal">
                        ...
                        <!--<div class="col-md-12">
                            <div class="form-group" style="padding-top:20px;">
                                <label class="control-label col-md-2">Smart Card ID:</label>
                                <div class="col-md-3">
                                    <select kendo-combo-box
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="Submit"  class="btn btn-success" ng-disabled="!stb_box_id" value="Save" />
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form name="business_region" id="business_region" method="post" ng-submit="saveBusinessRegion()" class="form-horizontal">
                        ...
                        <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                    <input type="submit" id="save" ng-disabled="business_region.$invalid" class="btn btn-success" value="Save Business Region"/>
                ...
                <div id="package_assign" class="tab-pane active" ng-show="tabs.package_assign" style="padding-top:10px;">
                    <form name="package_assign" id="package_assign" ng-submit="assignPackages()" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    ...
                                    <select id="select-from" ng-model="selected_item" style="width:310px;min-height:100px;" ng-model="selected_package" multiple="multiple" >
                                        <option ng-repeat="p in packages" ng-show="{{p.package_type!='CATCHUP'}}"  style="font-size:13px" value="{{p.id}}" >{{p.package_name}} - [ Price:{{p.price}} - Duration:{{p.duration}} - Count:{{p.no_of_program}} ]</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="select-to" ng-model="included_item" style="width:310px;min-height:100px;" ng-model="selected_package" multiple="multiple" >
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <label class="control-label"><input type="radio" ng-model="charge_type" ng-disabled="!assigned_packages.length" value="1" /> Amount</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <label class="control-label"><input type="radio" ng-model="charge_type" ng-disabled="!assigned_packages.length" value="0" /> Package</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <input type="submit" ng-disabled="isDisabledAssignPackage()" class="btn btn-success" value="Assign Package & Charge"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" ng-repeat="ap in assigned_package_list">
                        ...
                        <div class="col-md-12">    
                            <div class="col-md-12">
                                <h4 style="border-bottom:1px solid #dedede;">Package ID: {{ap.package_id}} [ <small>No of days: {{ap.no_of_days}}</small> ] [ <small>Charge Type: {{((ap.charge_type=='1')?  'By Amount':'By Package')}}</small> ]
