            ...
            <div class="col-md-12">
                    ...
                    <form name="subscriber_login" id="subscriber_login" method="post" ng-submit="saveLogin()">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <input type="submit" ng-disabled="isSaveLoginDisabled()" id="buttonsuccess" ng-diabled="subscriber_login.$invalid" class="btn btn-success" value="Save Login Info"/>
                                </div>
                            </div>
                    ...
                    <form name="stb-card" id="stb-card" method="post" ng-submit="addStbCard()" class="form-horizontal">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="Submit" id="buttonsuccess" class="btn btn-success" ng-disabled="!stb_box_id" value="Save" />
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div id="package_assign" class="tab-pane active" ng-show="tabs.package_assign" style="padding-top:10px;">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    ...
                                    <select id="select-from" ng-model="selected_item"  style="min-width:245px;min-height:100px;" ng-model="selected_package" multiple="multiple" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="select-to" ng-model="included_item"  style="min-width:245px;min-height:100px;" ng-model="selected_package" multiple="multiple" >
                    ...
                    <div class="row" ng-repeat="ap in assigned_package_list">
                        <div class="col-md-12">    
                            <div class="col-md-12">
                                <h4 style="border-bottom:1px solid #dedede;">Device ID: {{ap.pairing_id}} [ <small>No of days: {{ap.no_of_days}}</small> ] [ <small>Charge Type: {{((ap.charge_type=='1')?  'By Amount':'By Package')}}</small> ] </h4>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="row" >
        ...
        <div class="col-md-12">
            <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Subscribers
                        <a ng-if="permissions.create_permission == '1'" href="<?php echo site_url('subscriber/import'); ?>" class="btn btn-primary btn-sm pull-right" style="margin-left:10px;"><i class="fa fa-plus-circle"></i> Import Subscriber</a>
        ...
        <div class="col-md-12" ng-if="!loader">
            <div class="panel-body">
                <form class="form-horizontal" ng-submit="filterSubscriberList()">
                    <div class="form-group">
                ...
                <a ng-click="downloadSubscriberList()" class="btn btn-default pull-right" style="position:relative;right:0px; bottom:10px;"><i class="fa fa-download"></i> Download</a>
                <a href="<?php echo site_url('subscriber/recharge-all'); ?>" class="btn btn-default pull-right" style="position:relative;right:5px; bottom:10px;"><i class="glyphicon glyphicon-usd"></i> Bulk Recharge</a>
                <a ng-click="bulkRenew()" class="btn btn-default pull-right" style="position:relative;right:10px; bottom:10px;"><i class="glyphicon glyphicon-refresh"></i> Bulk Renew</a>
                <br style="clear:both;"/>
