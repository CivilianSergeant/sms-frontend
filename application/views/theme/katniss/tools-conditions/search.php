...
<div id="container" ng-controller="conditionalSearch" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Conditional Program Search
            ...
            <form class="form-horizontal" ng-submit="sendConditionalSearch()">
            <div class="col-md-12">
