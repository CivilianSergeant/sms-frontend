...
<div id="container" ng-controller="conditionalLimited" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> Conditional Limited
            ...
            <form class="form-horizontal" ng-submit="sendConditionalLimited()">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-2 col-md-offset-1">
                            <label class="control-label col-md-12" style="text-align:left;">Package List</label>
                            <div class="col-md-12">
                                <select id="select-from" ng-model="selected_item"  style="min-width:145px;min-height:190px;" multiple="multiple" >
                                    <option ng-repeat="p in packages"  style="font-size:13px" value="{{p.id}}" >{{p.package_name}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-1" style="margin-top:30px;padding-right:0px;width:60px;">
                        ...
                        <div class="col-md-2" style="padding-left:0px;">
                            ...
                            <div class="col-md-12">
                                <select id="select-from" ng-model="included_item" style="min-width:145px;min-height:190px;" multiple="multiple" >
                                    <option ng-repeat="p in assigned_packages"  style="font-size:13px" value="{{p.id}}" >{{p.package_name}}</option>
                                </select>
                            </div>
                        </div>
