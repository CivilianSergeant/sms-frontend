        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-heading">
                        ...
                        <h4 class="widgettitle">MSO User [ {{profile.mso_name}} ]
                            <a href="<?php echo site_url('mso/edit/{{profile.token}}' ) ?>" class="btn btn-success btn-sm pull-right paddin-left" style="margin-left: 10px"><i class="fa fa-pencil"></i> Edit</a>
            ...
            <div class="col-md-12">
                <div class="panel-body">
                    <div class="tab-content" ng-if="!loader">
                        <div class="profile panel-body tab-pane active" id="profile">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label id="view" class="col-sm-4 control-label">Photo</label>
                                       
                                        <!--<a href="<?php /*echo base_url('/'); */?>{{profile.photo}}" data-lightbox="example-2"  data-title="<a href='<?php /*echo site_url('mso/image_download')*/?>/{{profile.token}}/?id=mso_profile'>Download</a>">-->
                                        
                                        <img id="pic" ng-show="profile.photo" ng-src="<?php echo base_url('/'); ?>{{profile.photo}}"/>
                        ...
                        <div class="profile panel-body tab-pane active" id="login">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label id="view" class="col-md-4 control-label" for="username">Username</label>                      
                                        : {{profile.mso_name}}
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="profile panel-body tab-pane active" id="identity_verify">
                            <div class="widgettitle">
                                <div class="col-md-12">
                                    <h4>Attach Identity Verfication Document</h4>
                                    <hr/>
                                </div>
                            </div>
                           <div class="row">
