...
<div id="container" ng-controller="PosStatement" ng-cloak>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel-heading">
                    ...
                    <h4 class="widgettitle"> POS Statement
            ...
            <form class="form-horizontal">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <input style="margin-left:15px;" type="text" placeholder="From Date" ng-model="formData.from_date" kendo-datepicker k-format="'yyyy-MM-dd'"/>
                    </div>
                    <div class="col-md-3" style="margin-left:-65px;">
                        <input type="text" placeholder="To Date" ng-model="formData.to_date" kendo-datepicker k-format="'yyyy-MM-dd'"/>
                    </div>
                    ...
                    <div class="col-md-1" style="padding-left: 35px; margin-top:20px;">
                        <div class="form-group">
                            <div class="col-md-3">
