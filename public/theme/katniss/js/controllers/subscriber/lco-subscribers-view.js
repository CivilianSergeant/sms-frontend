...
app.controller('EditSubscriberProfile',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
    ...
    var uploader = $scope.uploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'lco-subscribers/upload_photo'
    });
    ...
    var identityUploader = $scope.identityUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'lco-subscribers/upload_identity'
    });
    ...
    var subuscriptionUploader = $scope.subuscriptionUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'lco-subscribers/upload_subscription_copy'
    });
    ...
    $scope.confirmStbSmartCard = function(i){
        ...
        var http = WebService.post('lco-subscribers/assign-stb-smartcard',formData);
    ...
    $scope.updateProfile = function(){
        resetMessage();
        var http = WebService.post('lco-subscribers/update_profile',$scope.profile);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.updateLogin = function(){
        ...
        var http = WebService.post('lco-subscribers/update_login_info',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status==400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.saveBillingAddress = function(){
        ...
        var http = WebService.post('lco-subscribers/save_billing_address',$scope.billing_address);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.saveBusinessRegion = function(){
        ...
        var http = WebService.post('lco-subscribers/save_business_region',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackages = function(){
        ...
        var http = WebService.post('lco-subscribers/save_assign_packages',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackage = function(){
        ...
        var http = WebService.post('lco-subscribers/has_package_assigned',formData);
        http.then(function(response){
    ...
    $scope.confirmPackageItem = function(i){
        ...
        var http = WebService.post('lco-subscribers/save_assign_packages',item);
        http.then(function(response){
            var data = response.data;
            console.log(data);
            if(data.status == 400){
    ...
    var loadPackages = function(){
        ...
        var http = WebService.get('lco-subscribers/ajax_get_packages/'+$scope.token);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadBalance = function(){
        var http = WebService.post('lco-subscribers/ajax_get_balance',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadUnusedCards = function(){
        ...
        var http = WebService.post('lco-subscribers/ajax_get_unused_cards',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
                $scope.stbs = data.stbs;
    ...
    var loadBusinessRegion = function(){
        var http = WebService.get('lco-subscribers/load_region');
        http.then(function(response){
            var data = response.data;
            $scope.regions = data;
    ...
    var loadProfile = function(){
        ...
        var http = WebService.get('lco-subscribers/ajax_get_profile/'+$scope.token);
        http.then(function(response){
            var data = response.data;
...
*/
    ...
    var loadLocations = function(type,model){
        ...
        var http = WebService.post('lco-subscribers/location/ajax_get_request/'+type,formData);
        http.then(function(response){
            var data = response.data;
            if(type == 'divisions'){
