...
app.controller('ViewGroupProfile',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
    ...
    var generateKendoGird = function(){
        $scope.mainGridOptions = {
            dataSource: {
                ...
                transport: {
                    read: {
                        url: SITE_URL+"groups/ajax-get-lco-by-group/"+$scope.token+"/",
                        dataType: "json",
                    }
                },
            ...
            columns: [
                ...
                {field: "", title: "Action",width: "auto",filterable:false,template:"<a href='"+SITE_URL+"lco/view/#=data.token#' class='btn btn-default btn-xs' data-toggle='tooltip' data-placement='left' title='View'><i class='fa fa-search'></i></a> <a ng-if='permissions.edit_permission == \"1\"' href='lco/edit/#=data.token#' class='btn btn-default btn-xs tool1' data-toggle='tooltip' data-placement='left' title='Edit'><i class='fa fa-pencil'></i></a>"},
            ]
        };
    };
