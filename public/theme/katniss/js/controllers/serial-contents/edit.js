...
app.controller('SerialProgram',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
    ...
    var loadProgram  = function(){
        var http = WebService.get('serial-contents/ajax-get-program/'+programId);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    $scope.updateIpTvProgram = function(){
        ...
        var http = WebService.post('serial-contents/update-program',$scope.formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
