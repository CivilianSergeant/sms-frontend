...
app.controller('EditLCOProfile',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
...
$scope.updateProfile = function(){
    ...
    var http = WebService.post('lco/update_profile',$scope.profile);
...
$scope.updateLogin = function(){
    ...
    var loadProfile = function(){
        var http = WebService.get('lco/ajax_get_profile/'+$scope.token);
        http.then(function(response){
            var data = response.data;
...
//            }
            ...
            $scope.copy_profile = $scope.billing_address.is_same_as_profile;
            $scope.is_same_as_billing_contact = $scope.billing_address.is_same_as_contact;
   ...
   $scope.saveBillingAddress = function(){
        $scope.billing_address.is_same_as_profile = $scope.copy_profile;
        $scope.billing_address.is_same_as_contact = $scope.is_same_as_billing_contact;
        $scope.billing_address.token  = $scope.token;
    ...
    $scope.setBillingContact = function(){

        if($scope.is_same_as_billing_contact=='1'){
            //$scope.profile.billing_contact = $scope.profile.contact;
            $scope.billing_address.billing_contact = $scope.billing_address.contact;
        } else{
            //$scope.profile.billing_contact = null;
            $scope.billing_address.billing_contact = "";
        }
    }
