...
app.controller('CreateSubscriberProfile',['$scope','WebService','FileUploader','$timeout',function($scope,WebService,FileUploader,$timeout){
    ...
    var uploader = $scope.uploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'subscriber/upload-photo'
    });
    ...
    var identityUploader = $scope.identityUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'subscriber/upload-identity'
    });
    ...
    var subuscriptionUploader = $scope.subuscriptionUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'subscriber/upload-subscription-copy'
    });
    ...
    $scope.setTab = function(tab){
     ...
     var loadPackages = function(){
        ...
        var http = WebService.get('subscriber/ajax-get-packages/'+$scope.token);
    ...
    var loadBalance = function(){
        var http = WebService.post('subscriber/ajax-get-balance',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadAssignedPackages = function(){
        var http = WebService.post('subscriber/ajax-get-assigned-packages',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
     ...
     var loadUnusedCards = function(){
        ...
        var http = WebService.post('subscriber/ajax-get-unused-cards',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    $scope.saveLogin = function(){
        ...
        if($scope.token != null || $scope.token != undefined){
            var http = WebService.post('subscriber/update-login-info',formData);
        } else{
            var http = WebService.post('subscriber/create-login-info',formData);
        }
    ...
    $scope.saveProfile = function(){
        ...
        var http = WebService.post('subscriber/create-profile',$scope.profile);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackages = function(){
        ...
        formData.form_type = 0;
        var http = WebService.post('subscriber/save-assign-packages',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    var loadBusinessRegion = function(){
        var http = WebService.get('subscriber/ajax-load-region');
        http.then(function(response){
            var data = response.data;
            $scope.regions = data;
    ...
    var loadLcoProfile = function(){
        var http = WebService.get('subscriber/ajax-load-lco-profile');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadProfiles = function(){
        ...
        var http = WebService.get('subscriber/ajax-get-profiles');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
        ...
        $scope.mainGridOptions = {
            dataSource: {
               /* 
                ...
                transport: {
                    read: {
                        url: "subscriber/ajax-get-profiles",
                        dataType: "json",
                    }
                },
                schema: {
    ...
    $scope.saveBusinessRegion = function(){
        ...
        formData.form_type = 0;
        var http = WebService.post('iptv-subscribers/save-business-region',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    var loadPermissions = function(){
        var http = WebService.get('subscriber/ajax-get-permissions');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadLocations = function(type,model){
        ...
        var http = WebService.post('iptv-subscribers/location/ajax-get-request/'+type,formData);
        http.then(function(response){
            var data = response.data;
            if(type == 'divisions'){
