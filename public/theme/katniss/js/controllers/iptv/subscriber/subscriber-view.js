...
app.controller('EditSubscriberProfile',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
    ...
    $scope.updateLogin = function(){
        ...
        var http = WebService.post('iptv-subscribers/update-login-info',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status==400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackage = function(){
        ...
        var http = WebService.post('iptv-subscribers/has-package-assigned',formData);
        http.then(function(response){
    ...
    var loadPackages = function(){
        ...
        var http = WebService.get('iptv-subscribers/ajax-get-packages/'+$scope.token);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadBalance = function(){
        var http = WebService.post('iptv-subscriber/ajax-get-balance',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadUnusedCards = function(){
        ...
        var http = WebService.post('iptv-subscribers/ajax-get-unused-cards',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
                $scope.stbs = data.stbs;
    ...
    var loadBusinessRegion = function(){
        var http = WebService.get('iptv-subscribers/ajax-load-region');
        http.then(function(response){
            var data = response.data;
            $scope.regions = data;
    ...
    var loadProfile = function(){
        ...
        var http = WebService.get('iptv-subscribers/ajax-get-profile/'+$scope.token);
        http.then(function(response){
            var data = response.data;
...
*/
    ...
    var loadPermissions = function(){
        var http = WebService.get('iptv-subscribers/ajax-get-permissions');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
