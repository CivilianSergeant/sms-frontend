...
app.controller('EditSubscriberProfile',['$scope','WebService','FileUploader',function($scope,WebService,FileUploader){
    ...
    $scope.updateProfile = function(){
        resetMessage();
        var http = WebService.post('my-members/update-profile',$scope.profile);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackages = function(){
        ...
        var http = WebService.post('my-members/save_assign_packages',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackage = function(){
        ...
        var http = WebService.post('my-members/has-package-assigned',formData);
        http.then(function(response){
    ...
    $scope.confirmPackageItem = function(i){
        ...
        var http = WebService.post('my-members/save_assign_packages',item);
        http.then(function(response){
            var data = response.data;
            console.log(data);
            if(data.status == 400){
    ...
    var loadProfile = function(){
        ...
        var http = WebService.get('my-members/ajax-get-profile/'+$scope.token);
        http.then(function(response){
            var data = response.data;
...
*/
    ...
    var validateForm = function(){
        ...
        /*$scope.$watch('profile.billing_contact',function(val){
            ...
            {
                if(!val.match(pattern)){
                    $scope.warning_messages = 'ssContact Number should be numerice value';
