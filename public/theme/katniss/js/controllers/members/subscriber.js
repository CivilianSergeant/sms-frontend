...
app.controller('CreateSubscriberProfile',['$scope','WebService','FileUploader','$timeout',function($scope,WebService,FileUploader,$timeout){
    ...
    var uploader = $scope.uploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'my-members/upload-photo'
    });
    ...
    var identityUploader = $scope.identityUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'my-members/upload-identity'
    });
    ...
    var subuscriptionUploader = $scope.subuscriptionUploader = new FileUploader({
        headers: {'X-Requested-With':'XMLHttpRequest'},
        url: SITE_URL+'my-members/upload-subscription-copy'
    });
    ...
    $scope.setTab = function(tab){
     ...
     var loadPackages = function(){
        ...
        var http = WebService.get('my-members/ajax-get-packages/'+$scope.token);
    ...
    var loadBalance = function(){
        var http = WebService.post('my-members/ajax-get-balance',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadAssignedPackages = function(){
        var http = WebService.post('my-members/ajax-get-assigned-packages',{token:$scope.token});
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
     ...
     var loadUnusedCards = function(){
        ...
        var http = WebService.post('my-members/ajax-get-unused-cards',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    $scope.confirmStbSmartCard = function(i){
        ...
        var http = WebService.post('my-members/assign-stb-smartcard',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status==400){
    ...
    $scope.saveLogin = function(){
        ...
        if($scope.token != null || $scope.token != undefined){
            var http = WebService.post('my-members/update-login-info',formData);
        } else{
            var http = WebService.post('my-members/create-login-info',formData);
        }
    ...
    $scope.saveProfile = function(){
        ...
        var http = WebService.post('my-members/create-profile',$scope.profile);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.assignPackages = function(){
        ...
        formData.form_type = 0;
        var http = WebService.post('my-members/save-assign-packages',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    var loadBusinessRegion = function(){
        var http = WebService.get('my-members/ajax-load-region');
        http.then(function(response){
            var data = response.data;
            $scope.regions = data;
    ...
    var loadLcoProfile = function(){
        var http = WebService.get('my-members/ajax-load-lco-profile');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadProfiles = function(){
        ...
        var http = WebService.get('my-members/ajax-get-profiles');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
        ...
        $scope.mainGridOptions = {
            dataSource: {
               /* 
                ...
                transport: {
                    read: {
                        url: SITE_URL+"my-members/ajax-get-profiles",
                        dataType: "json",
                    }
                },
                schema: {
            ...
            columns: [
                ...
                {field: "username", title: "User name",width: "270px"},
                ...
                template:"<a  href='"+SITE_URL+"my-members/view/#=data.token#' class='btn btn-default btn-xs' data-toggle='tooltip' data-placement='left' title='View'><i class='fa fa-search'></i></a> <a  href='"+SITE_URL+"my-members/edit/#=data.token#' class='btn btn-default btn-xs' data-toggle='tooltip' data-placement='left' title='Edit'><i class='fa fa-pencil'></i></a> <a ng-if='permissions.edit_permission==\"1\"' href='"+SITE_URL+"my-members/subscriber-recharge/#=data.token#' class='btn btn-success btn-xs'>Recharge</a> <a ng-if='permissions.edit_permission==\"1\"' href='"+SITE_URL+"my-members/migrate/#=data.token#' class='btn btn-danger btn-xs'>Migrate</a> <a ng-if='permissions.edit_permission==\"1\"' href='"+SITE_URL+"my-members/charge/#=data.token#/all' class='btn btn-warning btn-xs'>Charge Fee</a>"
    ...
    $scope.saveBillingAddress = function(){
        resetMessage();
        var http = WebService.post('my-members/save-billing-address',$scope.billing_address);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    $scope.saveBusinessRegion = function(){
        ...
        formData.form_type = 0;
        var http = WebService.post('my-members/save-business-region',formData);
        http.then(function(response){
            var data = response.data;
            if(data.status == 400){
                $scope.warning_messages = data.warning_messages;
    ...
    var loadPermissions = function(){
        var http = WebService.get('my-members/ajax-get-permissions');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    /*var loadAllLco = function(){
        var http = WebService.get('iptv-subscribers/ajax-get-lco');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200)
            {
    ...
    /*var loadAllReferences = function(){
        var http = WebService.get('iptv-subscribers/ajax-get-references');
        http.then(function(response){
            var data = response.data;
            if(data.status == 200){
    ...
    var loadLocations = function(type,model){
        ...
        var http = WebService.post('my-members/location/ajax-get-request/'+type,formData);
        http.then(function(response){
            var data = response.data;
            if(type == 'divisions'){
